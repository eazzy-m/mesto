...
const addCardFormPlaceName = container.querySelector('.form__item_place-name');
const addCardFormImageSrc = container.querySelector('.form__item_place-image-source');
